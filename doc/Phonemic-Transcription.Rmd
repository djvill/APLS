...
On the other hand, if a word is unlikely to be used by more than one speaker, it's better to just use an [inline DISC code](https://djvill.github.io/APLS/doc/Transcription-Convention.html#novel-words).
Singular and plural forms don't need to be added to the dictionary separately, unless the plural is something other than the singular + _-s_.
...
For example, Pittsburghers often pronounce _Carnegie_ as [kɑɹˈneɪgi], whereas non-Pittsburghers almost always use [ˈkɑɹnəgi].
